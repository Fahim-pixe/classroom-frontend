...
const AdminUsersPage = () => {
  ...
  const table = useTable<User>({ columns, refineCoreProps: { resource: "users", pagination: { pageSize: 15, mode: "server" }, filters: { permanent: debouncedSearch ? [{ field: "search", operator: "contains" as const, value: debouncedSearch }] : [] }, sorters: { initial: [{ field: "id", order: "desc" }] } } });
